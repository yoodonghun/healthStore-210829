	       ...
	       <div class="d-flex justify-content-center">
				...
				<div>
				  <div class="bottom-imageBox d-flex justify-content-between">
					<div class="detail1">
						<a href="/product/detail_view" class="text-blue"><img src="https://image.g9.co.kr/g/2173112733/n?ts=1627629743000" alt="" width="450px" height="450px">
					...
					<div class="detail2">
						<a href="/product/detail_view" class="text-blue"><img src="https://thumbnail10.coupangcdn.com/thumbnails/remote/492x492ex/image/vendor_inventory/e0d0/fb2e4e49164cbc56ca2e783f24b189b6f0c9cf296741e42ad0c0d0801f22.png" alt="" width="450px" height="450px">
						<div class="font-weight-bold mt-4"><h4>힙딥밴드 하체근력 운동기구</h4></a></div><br>
						<div class="text-danger"><h4>9,000원</h4></div>
					</div>

					<div class="detail3">
						<a href="/product/detail_view" class="text-blue"><img src="http://www.thesallim.co.kr/shopimages/somefw/0080070000362.jpg?1598233358" alt="" width="450px" height="450px">
