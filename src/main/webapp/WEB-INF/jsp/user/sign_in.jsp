					...
					<div class="inputBox mt-4">
						<div class="d-flex justify-content-center">
							<input type="text" id="loginId" name="loginId"
								class="inputId  col-5" placeholder="ID">
						</div>
					</div>
				</div>
					...
					<div class="inputBox ">
						<div class="d-flex justify-content-center">
							<input type="password" id="password" name="password"
								class="inputPw  col-5" placeholder="PW">
						</div>
					</div>
				</div>
					...
					<div class="inputBox ">
						<div class="d-flex justify-content-center">
							<button type="submit" id="signInBtn"
								class="signInBtn btn-secondary form-control">로그인</button>
						</div>
					</div>
				</div>
							...
							<div class="d-flex justify-content-center">
								...
								<a href="/user/sign_up_view" class="text-white">
									<button type="button" id="signUpBtn"
										class="signUpBtn btn-secondary form-control">회원가입</button>
								</a>
							</div>
						</div>
					</div>
